...
{
printf("fudge= %.6e\n",fudge);
printf("detector_thickstep= %.6e\n",detector_thickstep);
printf("Odet= %.6e\n",Odet);
// Iterate over each element and print its value
for (int i = 0; i < 4; i++) {
    printf("pix0_vector[%d] = %.6e\n", i, pix0_vector[i]);
}
printf("close_distance= %.6e\n",close_distance);
printf("detector_thick= %.6e\n",detector_thick);
printf("detector_attnlen= %.6e\n",detector_attnlen);
printf("source_X[0]= %.6e\n",source_X[0]);
printf("source_Y[0]= %.6e\n",source_Y[0]);
printf("source_Z[0]= %.6e\n",source_Z[0]);
printf("source_lambda[0]= %.6e\n",source_lambda[0]);
printf("dmin= %.6e\n",dmin);
printf("phi0= %.6e\n",phi0);
printf("phistep= %.6e\n",phistep);
for (int i = 0; i < 4; i++) {
...
printf("mosaic_spread= %.6e\n",mosaic_spread);

for (int i = 0; i < 9; i++) {
    printf("mosaic_umats[%d]= %f\n",i,mosaic_umats[i]);
}
printf("V_cell= %.6e\n",V_cell);
printf("h_max= %d\n",h_max);
printf("h_min= %d\n",h_min);
...
// print all values used

printf("oversample= %d\n",oversample);
printf("override_source= %d\n",override_source);
printf("sources= %d\n",sources);
printf("spixels= %d\n",spixels);
printf("fpixels= %d\n",fpixels);
printf("pixel_size= %f\n",pixel_size);
...
printf("roi_ymin= %d\n",roi_ymin);
printf("roi_ymax= %d\n",roi_ymax);
printf("detector_thicksteps= %d\n",detector_thicksteps);
printf("r_e_sqr= %f\n",r_e_sqr);
printf("fluence= %f\n",fluence);
printf("amorphous_molecules= %f\n",amorphous_molecules);
printf("Fmap_pixel= %d\n",Fmap_pixel);
printf("detector_thickstep= %f\n",detector_thickstep);
printf("Odet= %f\n",Odet);
printf("fdet_vector= %f %f %f\n",fdet_vector[1],fdet_vector[2],fdet_vector[3]);
printf("sdet_vector= %f %f %f\n",sdet_vector[1],sdet_vector[2],sdet_vector[3]);
printf("odet_vector= %f %f %f\n",odet_vector[1],odet_vector[2],odet_vector[3]);
printf("pix0_vector= %f %f %f\n",pix0_vector[1],pix0_vector[2],pix0_vector[3]);
printf("curved_detector= %d\n",curved_detector);
printf("distance= %f\n",distance);
printf("beam_vector= %f %f %f\n",beam_vector[1],beam_vector[2],beam_vector[3]);
printf("close_distance= %f\n",close_distance);
printf("point_pixel= %d\n",point_pixel);
printf("detector_thick= %f\n",detector_thick);
printf("detector_attnlen= %f\n",detector_attnlen);
// iterate over sources and print

// for (int source_ind = 0; source_ind < sources; source_ind++) {
//     printf("source_I= %f\n",source_I[source_ind]);
//     printf("source_X= %f\n",source_X[source_ind]);
//     printf("source_Y= %f\n",source_Y[source_ind]);
//     printf("source_Z= %f\n",source_Z[source_ind]);
//     printf("source_lambda= %f\n",source_lambda[source_ind]);
// }

// // XXX print all values
// printf("stol_of= %f\n",stol_of[0]);
printf("stols= %f\n",stols);
// printf("Fbg_of= %f\n",Fbg_of[0]);

// get size of stol_of and Fbg_of
int stol_size = sizeof(stol_of)/sizeof(stol_of[0]);
int Fbg_size = sizeof(Fbg_of)/sizeof(Fbg_of[0]);
printf("stol_size= %d\n",stol_size);
printf("Fbg_size= %d\n",Fbg_size);
int total_stols = 18;
