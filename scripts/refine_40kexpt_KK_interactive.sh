# salloc -J psii_refine -N 4 -A m4734_g -C gpu --qos interactive --time 02:00:00 --ntasks-per-gpu=2
...
JOB_ID_SFACTORS=${2:-$JOB_ID_SFACTORS}
...
exafel.model.Nabc.value=12,8,4
