...
# create PyTorch model for the forward simulation
# make structure factors a parameter
# make orientation a trainable tensor outside the function
# get the A matrix from the orientation
